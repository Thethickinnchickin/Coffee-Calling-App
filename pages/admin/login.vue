        ...
        <div class="container">        
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <form @submit.prevent="adminLogin" class="mt-4">
                        <div class="a-box a-spacing-extra-large">
                            <div class="a-box-inner">
                                ...
                                <div class="a-row a-spacing-base">
                                    <label for="name" class="a-form-label">Your UserName</label>
    ...
    methods: {
        async adminLogin() {
            try {
                ...
                await this.$auth.loginWith('admin', {data: {name: this.name, password: this.password}})
